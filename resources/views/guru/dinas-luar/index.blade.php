...
<div class="card" style="margin-bottom:var(--space-5)">
    <form method="POST" action="{{ route('guru.kedinasan.store') }}" enctype="multipart/form-data" data-upload-form>
        ...
        <div class="form-group" style="margin-bottom:var(--space-5)"><label class="form-label" for="bukti_file">Bukti Lampiran *</label><input class="form-input" type="file" name="bukti_file" id="bukti_file" accept=".jpg,.jpeg,.png,.pdf" required><span class="form-help" id="fileInfo">JPG, PNG, atau PDF. Maksimal 5 MB.</span></div>
